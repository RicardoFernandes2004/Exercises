...
function Body() {
  ...
  function handleClick() {
    setFruta(changer);
    handleFrutaChange(changer); 
  }

  
  function handleFrutaChange(fruta) {
    switch (fruta) {
      case 'maçã':
  ...
  return (
    <div>
      <label htmlFor="fruta">Qual fruta você quer?</label>
      <input type="text" id="fruta" onChange={(change) => setChanger(change.target.value)} />
